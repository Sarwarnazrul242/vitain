<template>
  <div class="relative min-h-screen bg-[#0A0A0A] overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
      <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-b from-[#4ADE80]/10 to-[#3B82F6]/10 rounded-full blur-[120px] animate-pulse-slow"></div>
      <div class="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-t from-[#4ADE80]/10 to-[#3B82F6]/10 rounded-full blur-[120px] animate-pulse-slower"></div>
      ...
      <div class="w-full max-w-md">
          ...
          <div class="pin-container animate-fade-in-up">
            <div class="pin-input">
              <input
                ...
                class="w-full px-6 py-4 text-center text-2xl tracking-widest bg-white/5 border border-white/10 rounded-xl focus:border-[#4ADE80] focus:ring-2 focus:ring-[#4ADE80]/20 outline-none transition-all duration-300"
              />
            </div>
            <button 
              @click="verifyPin" 
            ...
            <p v-if="error" class="mt-4 text-red-400 text-center animate-fade-in">{{ error }}</p>
          </div>
        </div>
        ...
        <div v-else class="animate-fade-in">
          <div class="text-center mb-8">
            ...
            <p class="text-gray-400 text-lg">Please review and accept the terms</p>
          </div>

          <div class="agreement-container animate-fade-in-up">
            <div class="bg-white/5 border border-white/10 rounded-xl p-6 mb-6 max-h-[300px] overflow-y-auto custom-scrollbar">
              <h3 class="text-xl font-semibold mb-4 text-white">Terms and Conditions</h3>
              <div class="space-y-4 text-gray-300">
                <p>By accessing this website, you agree to the following terms:</p>
                <ol class="list-decimal list-inside space-y-2">
                  <li>You will use the information provided for personal health and wellness purposes only.</li>
                  <li>You understand that supplement recommendations are not a substitute for professional medical advice.</li>
                  <li>You will not share your access credentials with others.</li>
                  <li>You acknowledge that the information provided is based on your input and may need to be adjusted based on your specific circumstances.</li>
                  <li>You agree to consult with healthcare professionals before making significant changes to your supplement regimen.</li>
                </ol>
              </div>
            </div>
