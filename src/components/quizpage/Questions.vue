...
//   loading.value = sessionStorage.getItem("loading") ;
//   console.log("loading updated:", loading.value);
// }
...
//     //Ensures user is logged in/signed up before AI is queried
//     const auth = await handleLoginState();
//     if(!auth)
//     {
//       return;
//     }
    
//     formSubmission = quizData.value
//     sessionStorage.removeItem("quizData"); //Clear quizdata to avod double submit

//     //Ensures either the data stored as of when user is logged or before it is passed on to be submitted
//     if (!formSubmission)
//     {
//        formSubmission = formData.value
//     }
