<template>
    <section class="relative min-h-[60vh] flex items-center justify-center text-center px-4 bg-[#0A0A0A] overflow-hidden pb-24 pt-32">
        ...
        <div class="relative z-10 max-w-4xl mt-auto mx-auto">
            ...
            <p class="text-gray-300 text-lg md:text-xl mb-12 max-w-2xl mx-auto animate-fade-in-up">
                Answer a few questions to help us create your perfect supplement plan tailored to your unique needs and goals
            </p>
            ...
            <div class="flex justify-center items-center gap-16 mt-8 animate-fade-in">
                <div class="step-container group" v-for="step in 3" :key="step">
                    <div class="relative">
                        <div class="w-6 h-6 rounded-full transition-all duration-300 flex items-center justify-center"
                             :class="[
                                 step === 1 ? 'bg-gradient-to-r from-[#4ADE80] to-[#3B82F6] scale-125' : 'bg-white/20',
                                 'group-hover:scale-110'
                             ]"
                        >
                            <span class="text-xs font-bold" :class="step === 1 ? 'text-white' : 'text-white/60'">
                                {{ step }}
                            </span>
                        </div>
                        <div class="absolute -inset-3 bg-gradient-to-r from-[#4ADE80]/20 to-[#3B82F6]/20 rounded-full blur-sm"
                             v-if="step === 1"
                        ></div>
                    </div>
                    <div class="absolute -bottom-8 left-1/2 transform -translate-x-1/2 whitespace-nowrap text-sm font-medium"
            ...
            <!-- Estimated Time -->
            <div class="mt-12 text-gray-400 text-sm animate-fade-in-up" style="animation-delay: 0.5s">
